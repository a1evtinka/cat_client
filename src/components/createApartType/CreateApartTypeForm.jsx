...
import { putApartTypes } from '../../features/aparttypes/aparttypesSlice';
...
const ApartTypeForm = () => {
  ...
  const createApartsTypes = (e) => {
    e.preventDefault()
      ...
      dispatch(putApartTypes(data))
      navigate('/')
  }

  return (
    <>
      <form onSubmit={createApartsTypes} align="center"> 
        <div>
